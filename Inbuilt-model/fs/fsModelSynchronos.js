...
- If the file operation takes time, the JavaScript execution
  thread waits for it to complete file operation.
...
- The important interview point is:
  ...
  - Synchronous fs operation → blocks the JavaScript execution thread.
  - Asynchronous fs operation -> allows JavaScript to continue while the I/O operation is handled asynchronously.
